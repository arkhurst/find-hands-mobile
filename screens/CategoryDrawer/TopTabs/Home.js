...
import { Entypo, Octicons, MaterialIcons, Ionicons } from '@expo/vector-icons';
      ...
      <View style={styles.container}>
        <ImageBackground
          ...
          <View style={{ justifyContent: 'center', alignItems: 'center' }}>
            <Entypo name="home" size={28} color={'#43db90'} />
            <Text style={styles.imageText}>Home Improvement</Text>
